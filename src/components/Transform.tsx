  ...
  return (
      <div className={classes.trans}>
            <div className={classes.transform}>
                <span style={{ fontWeight:800, color:'black',fontSize:'20px',display:'block', 
            ...
            <div className={classes.wrap}>
                <div className={classes.wrapper}>
                    ...
                    <div className={classes.feature}>
                        <span style={{ marginBottom:'12px', fontWeight:800, color:'rgba(0, 0, 0, 0.87)',fontSize:'18px',display:'block', 
                        boxSizing:'border-box',outline:'none 0px', 
