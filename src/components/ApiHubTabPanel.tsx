...
const ApiHubTabPanel: React.FC<IApiHubTabPanel> = ({ children, className, value, index }) => {
  ...
  console.log(`${index}` )
  return (
    <div className={className} role="apihubtabpanel" hidden={value !== index} id={`simple-tab-${index}`}>
        {value === index && (
