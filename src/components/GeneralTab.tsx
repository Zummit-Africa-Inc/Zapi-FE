      ...
      <form>
        ...
        <Box mt={2}>
          <FormControl>
            ...
            <Select value={selected} onChange={handleChange} sx={{ marginTop: '10px', width: '320px' }}
              inputProps={{name: "agent", id: "age-simple"}}>
        ...
        <Box width="600px" mt={2}>
          ...
          <TextField variant="outlined" multiline id="description" maxRows={10} fullWidth={true} helperText="Describe in few words what’s this API do" />
        </Box>
        <Box width="600px" mt={2}>
        ...
        <Box width="600px" mt={2}>
          ...
          <TextField variant="outlined" multiline id="documentation" maxRows={10} fullWidth={true} helperText="Use this section to provide detailed documentation of your API and to highlight its benefits and features." />
        </Box>
        ...
        <Box mt={2}>
          ...
          <Typography variant="body1" fontSize="16px" fontWeight={400}>
            Switching your API visibility to Public make it searchable and accessible to everyone.
          </Typography>
