  ...
  return (
    <div className={classes.request}>
                            <div className={classes.text}>
                                <Typography variant='h6' style={{ fontWeight:800, color:'black',fontSize:'18px',display:'block', boxSizing:'border-box',outline:'none 0px',letterSpacing:'normal', lineHeight:'24px' }}>Request Schema Validation</Typography>
                            </div>
                            <div className={classes.field}>
                                <div className={classes.subfield}>
                                    <div className={classes.textfield}>
                                        ...
                                        <Typography variant='h6' style={{ marginTop:'4px', fontWeight:'800px', color:'black',fontSize:'14px',display:'block', boxSizing:'border-box',outline:'none 0px', letterSpacing:'normal',lineHeight:'16px' }}>
                                                ...
                                                <div className={classes.subcontain}>
                                                    <div className={classes.submain}>
                                                        ...
                                                        <Typography variant='h6' style={{ marginLeft:'16px', color:'rgba(0, 0, 0, 0.87)', 
                                                            fontSize:'16px', letterSpacing:'normal', lineHeight:'20px', display:'block',
