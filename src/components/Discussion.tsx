import { Typography, Link, Box, Pagination, Button } from "@mui/material";
      ...
      <Box className={classes.discussion_tab}>
        ...
        <Box>
          <Button
            ...
            <Add />{" "}
            <Typography sx={{ fontSize: "14px" }}>New Discussion</Typography>
          </Button>
        </Box>
      </Box>
                  ...
                  <Box className={classes.discussion_row}>
                    ...
                    <Box className={classes.discussion_column}>
                      <Typography variant="body1" fontWeight={500}>
                        <Link
                          sx={{ textDecoration: "none", color: "#071b85" }}
                      ...
                      <Typography variant="body2" fontWeight={400}>
                        Commented on -{" "}
                        {new Date(discussion?.createdOn).toLocaleDateString()}
                      </Typography>
                    </Box>
                  </Box>
                </Box>
