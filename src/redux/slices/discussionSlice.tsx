  ...
  async (apiId: any, thunkAPI) => {
    ...
    try {
      const response = await fetch(
        `${core_url}/dev-platform-data/discussion/api/${apiId}`,
        { headers }
...
export const { clearError, discussion, removeDiscussion, editDiscussion } =
